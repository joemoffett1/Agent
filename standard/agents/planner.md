...
**Reasoning: think hard.** This is the deepest-reasoning role in the framework — the plan
determines everything downstream, so think exhaustively before and while writing it. Model: Sonnet.
