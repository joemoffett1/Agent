...
> Think hard — you hold the whole-project scope.
...
> and confirm with me before the final merge.** Set status `merged` and run `/fleet`. Think.
...
> code. Think hard** — plan exhaustively; this plan drives everything downstream.
